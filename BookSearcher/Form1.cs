        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    {
                        TextBoxOutput1.Text = folderName + "\\パターン1.csv";
                    }
                    else
                    {
                        TextBoxOutput1.Text = folderName + "\\パターン2.csv";
                    }
                    TextBoxOutput2.Text = folderName + "\\共通出力1.csv";
                    TextBoxOutput3.Text = folderName + "\\共通出力2.csv";
                }
            }
        }
